...
# Neo Service Layer Minimal Docker Setup Script
# This script sets up and runs only the MongoDB and Redis services using Docker
...
echo "Setting up Neo Service Layer using Docker (Minimal Version)..."
...
echo "Neo Service Layer Docker setup (Minimal Version) completed successfully!"
echo ""

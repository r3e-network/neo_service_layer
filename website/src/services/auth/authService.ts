 ...
 * 
 * This module provides authentication functionality for the Neo Service Layer website.
...
// Define the AuthenticationService class
export class AuthenticationService extends EventEmitter {
  ...
  private storeAuth(): void {
    if (!isBrowser || !this.wallet || !this.token) {
      return;
    }

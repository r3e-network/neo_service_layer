...
import (
	...
	"github.com/will/neo_service_layer/internal/services/api/middleware"
...
func NewService(config *Config, deps *Dependencies) (*Service, error) {
	...
	svc := &Service{
		config:       config,
		tokenAuth:    tokenAuth,
		functionsSvc: deps.FunctionsService,
		secretsSvc:   deps.SecretsService,

...
func (m *mocksecretservice) Get(key string) (string, error) {
...
func (m *mocksecretservice) GetSecret(ctx context.Context, functionID, key string) (string, error) {
	return m.Get(key)
}
func (m *mocksecretservice) SetSecret(ctx context.Context, functionID, key, value string) error {
	// Mock doesn't actually store, just return nil
	return nil
}
func (m *mocksecretservice) DeleteSecret(ctx context.Context, functionID, key string) error {
	// Mock doesn't actually store, just return nil
	return nil
}

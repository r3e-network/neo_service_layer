...
func (m *mockfunctionservice) CreateFunction(ctx context.Context, owner util.Uint160, name, description, code string, runtime functions.Runtime) (*functions.Function, error) {
...
func (m *mockfunctionservice) UpdateFunction(ctx context.Context, functionID string, updater util.Uint160, updates map[string]interface{}) (*functions.Function, error) {
...
func (m *mockfunctionservice) DeleteFunction(ctx context.Context, functionID string, deleter util.Uint160) error {
	args := m.Called(ctx, functionID, deleter)
	return args.Error(0)
}

func (m *mockfunctionservice) InvokeFunction(ctx context.Context, invocation functions.FunctionInvocation) (*functions.FunctionExecution, error) {
...
func (m *mockfunctionservice) ListFunctions(ctx context.Context, owner util.Uint160) ([]*functions.Function, error) {
...
func (m *mockfunctionservice) ListExecutions(ctx context.Context, functionID string, limit int) ([]*functions.FunctionExecution, error) {
...
func (m *mockfunctionservice) GetPermissions(ctx context.Context, functionID string) (*functions.FunctionPermissions, error) {
	args := m.Called(ctx, functionID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *mockfunctionservice) UpdatePermissions(ctx context.Context, functionID string, updater util.Uint160, permissions *functions.FunctionPermissions) error {
	args := m.Called(ctx, functionID, updater, permissions)
	return args.Error(0)
}

func (m *mocksecretservice) StoreSecret(ctx context.Context, userAddress util.Uint160, key, value string, options map[string]interface{}) error {
	args := m.Called(ctx, userAddress, key, value, options)
	return args.Error(0)
}

func (m *mocksecretservice) GetSecret(ctx context.Context, userAddress util.Uint160, key string) (string, error) {
	args := m.Called(ctx, userAddress, key)
	return args.String(0), args.Error(1)
}

func (m *mocksecretservice) DeleteSecret(ctx context.Context, userAddress util.Uint160, key string) error {
	args := m.Called(ctx, userAddress, key)
	return args.Error(0)
}

func (m *mocksecretservice) ListSecrets(ctx context.Context, userAddress util.Uint160) ([]string, error) {
...
func setupTestService(t *testing.T) (*Service, *mockDependencies) {
	...
	deps := &Dependencies{
		functionservice:  mocks.functionservice,
